...
function tasksOnLoad() {
    ...
    document.querySelector('.thumbnail.image-0').addEventListener('click', function () {
        scrollTo(0);
    });
    document.querySelector('.thumbnail.image-1').addEventListener('click', function () {
        scrollTo(1);
    });
    document.querySelector('.thumbnail.image-2').addEventListener('click', function () {
        scrollTo(2);
    });
    document.querySelector('.thumbnail.image-3').addEventListener('click', function () {
        scrollTo(3);
    });
}
